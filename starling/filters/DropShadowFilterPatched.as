...
package starling.filters
{
     ...
     */
    public class DropShadowFilterPatched extends FragmentFilterPatched
    {
        private var _blurFilter:BlurFilterPatched;
        private var _compositeFilter:CompositeFilterPatched;
         ...
         */
        public function DropShadowFilterPatched(distance:Number=4.0, angle:Number=0.785,
                                         color:uint=0x0, alpha:Number=0.5, blur:Number=1.0,
                                         quality:Number=0.5, inner:Boolean=false, knockout:Boolean=false)
        {
            _compositeFilter = new CompositeFilterPatched();
            _blurFilter = new BlurFilterPatched(blur, blur);
            _distance = distance;
            _angle = angle;
